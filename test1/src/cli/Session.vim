...
set ruler
set runtimepath=~/.vim,~/.vim/pack/vendor/start/vim-airline,~/.vim/pack/vendor/start/syntastic,~/.vim/pack/vendor/start/nerdtree,~/.vim/pack/vendor/start/emmet-vim,~/.vim/pack/vendor/start/coc.nvim,/usr/share/vim/vimfiles,/usr/share/vim/vim82,/usr/share/vim/vimfiles/after,~/.vim/after
set scrolloff=5
set showcmd
...
silent only
silent tabonly
cd /media/furious/Data/Chungus/code/src/chunguscoin
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 15 + 118) / 237)
exe '2resize ' . ((&lines * 15 + 27) / 54)
exe 'vert 2resize ' . ((&columns * 221 + 118) / 237)
exe '3resize ' . ((&lines * 20 + 27) / 54)
exe 'vert 3resize ' . ((&columns * 221 + 118) / 237)
exe '4resize ' . ((&lines * 14 + 27) / 54)
exe 'vert 4resize ' . ((&columns * 221 + 118) / 237)
argglobal
enew
file NERD_tree_1
let s:cpo_save=&cpo
...
wincmd w
argglobal
terminal ++curwin ++cols=221 ++rows=14 
