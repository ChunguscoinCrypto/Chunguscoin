...
# Input
DEPENDPATH += .
HEADERS += src\chunguscoin_globals.h \
...
# also add new translations to chunguscoin.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/chunguscoin_*.ts)
...
macx:ICON = src/qt/res/icons/chunguscoin.icns
macx:TARGET = "ChunguscoinGUI"
