...
; Settings 
Name "Chunguscoin (Chunguscoin-Qt)"
...
Section "Install Chunguscoin-Qt (GUI)" Section1
  SetOutPath $INSTDIR
  File "content\chunguscoin-qt-win.exe"
  CreateShortCut "$DESKTOP\Chunguscoin-Qt.lnk" "$INSTDIR\chunguscoin-qt-win.exe"
SectionEnd
