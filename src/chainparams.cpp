...
public:
    CMainParams()
    {
        ...
        genesis.nBits    = CHUNGUSCOIN_MINDIFF_NBITS;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("chunguscoinseeds.com", "kmd.chunguscoinseeds.com")); // @kolo, static dns seeds revised
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("z.cash", "dns.testnet.z.cash")); // Chunguscoin
...
void *chainparams_commandline()
{
    ...
    if ( ASSETCHAINS_SYMBOL[0] != 0 )
    {
        ...
        // only require coinbase protection on Verus from the Chunguscoin family of coins
