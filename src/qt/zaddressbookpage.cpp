    ...
    tab(_tab)
{
    ...
    {
    case SendingTab:
        ui->labelExplanation->setText(tr("These are your Chunguscoin z-addresses for sending payments. Always check the amount and the receiving z-address before sending coins."));
        ui->deleteAddress->setVisible(true);
        break;
    case ReceivingTab:
        ui->labelExplanation->setText(tr("These are your Chunguscoin z-addresses for receiving payments. It is recommended to use a new receiving z-address for each transaction."));
