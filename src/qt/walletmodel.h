...
#ifndef CHUNGUSCOIN_QT_WALLETMODEL_H
#define CHUNGUSCOIN_QT_WALLETMODEL_H
...
/** Interface to Chunguscoin wallet from Qt view code. */
...
public:
    ...
    // Private Send coins to a list of recipients
...
#endif // CHUNGUSCOIN_QT_WALLETMODEL_H
