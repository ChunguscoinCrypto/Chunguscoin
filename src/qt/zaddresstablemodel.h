...
#ifndef CHUNGUSCOIN_QT_ZADDRESSTABLEMODEL_H
#define CHUNGUSCOIN_QT_ZADDRESSTABLEMODEL_H
...
public:
    ...
    enum ColumnIndex {
        ...
        Address = 3  /**< Chunguscoin z-address */
    };
...
#endif // CHUNGUSCOIN_QT_ZADDRESSTABLEMODEL_H
