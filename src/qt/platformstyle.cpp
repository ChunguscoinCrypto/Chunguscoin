    ...
    textColor(0,0,0)
{
    ...
    if (colorizeIcons) {
        ...
        // QColor colorbase = QColor(0, 94, 94); // Chunguscoin Color
        // QColor colorbase = QColor(38, 69, 107);  // Chunguscoin Dark Blue
        QColor colorbase = QColor(43, 102, 128);    // Chunguscoin Light Blue
