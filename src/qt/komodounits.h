...
#ifndef CHUNGUSCOIN_QT_CHUNGUSCOINUNITS_H
#define CHUNGUSCOIN_QT_CHUNGUSCOINUNITS_H
...
/** Chunguscoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class ChunguscoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit ChunguscoinUnits(QObject *parent);

    /** Chunguscoin units.
      @note Source: https://en.chunguscoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        KMD,
...
typedef ChunguscoinUnits::Unit ChunguscoinUnit;

#endif // CHUNGUSCOIN_QT_CHUNGUSCOINUNITS_H
