# libcryptoconditions [![Build Status](https://travis-ci.org/libscott/libcryptoconditions.svg?branch=chunguscoin)](https://travis-ci.org/libscott/libcryptoconditions)
