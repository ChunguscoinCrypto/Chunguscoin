/*
 ...
 Just update the functions in this file, then from ~/chunguscoin/src/cc
 
 ../chunguscoin-cli -ac_name=CUSTOM stop
 ./makecustom
 ../chunguscoind -ac_name=CUSTOM -ac_cclib=custom -ac_cc=2 ...
 
 The above will rebuild chunguscoind and get it running again
 */
...
{
    CMutableTransaction mtx = CreateNewContextualCMutableTransaction(Params().GetConsensus(), chunguscoin_nextheight()); std::string rawtx;
