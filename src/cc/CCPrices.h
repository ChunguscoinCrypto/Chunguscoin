...
extern void GetChunguscoinEarlytxidScriptPub();
...
#define CHUNGUSCOIN_MAXPRICES 2048 // must be power of 2 and less than 8192
#define CHUNGUSCOIN_PRICEMASK (~(CHUNGUSCOIN_MAXPRICES -  1))     // actually 1111 1000 0000 0000
#define PRICES_WEIGHT (CHUNGUSCOIN_MAXPRICES * 1)            //          0000 1000 0000 0000
#define PRICES_MULT (CHUNGUSCOIN_MAXPRICES * 2)              //          0001 0000 0000 0000
#define PRICES_DIV (CHUNGUSCOIN_MAXPRICES * 3)               //          0001 1000 0000 0000
#define PRICES_INV (CHUNGUSCOIN_MAXPRICES * 4)               //          0010 0000 0000 0000
#define PRICES_MDD (CHUNGUSCOIN_MAXPRICES * 5)               //          0010 1000 0000 0000
#define PRICES_MMD (CHUNGUSCOIN_MAXPRICES * 6)               //          0011 0000 0000 0000
#define PRICES_MMM (CHUNGUSCOIN_MAXPRICES * 7)               //          0011 1000 0000 0000
#define PRICES_DDD (CHUNGUSCOIN_MAXPRICES * 8)               //          0100 0000 0000 0000
