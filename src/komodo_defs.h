...
#define CHUNGUSCOIN_EARLYTXID_HEIGHT 100
//#define ADAPTIVEPOW_CHANGETO_DEFAULTON 1572480000
#define ASSETCHAINS_MINHEIGHT 128
#define ASSETCHAINS_MAX_ERAS 7
#define CHUNGUSCOIN_ELECTION_GAP 2000
#define ROUNDROBIN_DELAY 61
#define CHUNGUSCOIN_ASSETCHAIN_MAXLEN 65
#define CHUNGUSCOIN_LIMITED_NETWORKSIZE 4
#define IGUANA_MAXSCRIPTSIZE 10001
#define CHUNGUSCOIN_MAXMEMPOOLTIME 3600 // affects consensus
#define CRYPTO777_PUBSECPSTR "020e46e79a2a8d12b9b5d12c7a91adb4e454edfae43c0a0cb805427d2ac7613fd9"
#define CHUNGUSCOIN_FIRSTFUNGIBLEID 100
#define CHUNGUSCOIN_SAPLING_ACTIVATION 1544832000 // Dec 15th, 2018
#define CHUNGUSCOIN_SAPLING_DEADLINE 1550188800 // Feb 15th, 2019
...
extern const uint32_t nS5Timestamp; //dPoW Season 5 June 14th, 2021 hardfork (03:00:00 PM UTC) (defined in chunguscoin_globals.h)
extern const int32_t nS5HardforkHeight;   //dPoW Season 5 June 14th, 2021 hardfork estimated block height (defined in chunguscoin_globals.h)
...
static const char *notaries_elected[NUM_KMD_SEASONS][NUM_KMD_NOTARIES][2] =
{
    ...
    },
    {
        ...
        {"chunguscoinninja_EU", "038e567b99806b200b267b27bbca2abf6a3e8576406df5f872e3b38d30843cd5ba" },
        {"chunguscoinninja_SH", "033178586896915e8456ebf407b1915351a617f46984001790f0cce3d6f3ada5c2" },
        {"chunguscoinpioneers_SH", "033ace50aedf8df70035b962a805431363a61cc4e69d99d90726a2d48fb195f68c" },
    ...
    },
    {
        ...
        {"chunguscoinpioneers_SH", "032a238a5747777da7e819cfa3c859f3677a2daf14e4dce50916fc65d00ad9c52a" },
        {"chunguscoinpioneers_EU", "036d02425916444fff8cc7203fcbfc155c956dda5ceb647505836bef59885b6866" },
   ...
   {    
        ...
        {"chunguscoinpioneers_EU", "0351f7f2a6ecce863e4e774bfafe2e59e151c08bf8f350286763a6b8ed97274b82"},
...
#define CHUNGUSCOIN_MAXNVALUE (((uint64_t)1 << 63) - 1)
#define CHUNGUSCOIN_BIT63SET(x) ((x) & ((uint64_t)1 << 63))
#define CHUNGUSCOIN_VALUETOOBIG(x) ((x) > (uint64_t)10000000001*COIN)
...
extern uint32_t ASSETCHAINS_ALGO, ASSETCHAINS_VERUSHASH,ASSETCHAINS_EQUIHASH,CHUNGUSCOIN_INITDONE;

extern int32_t CHUNGUSCOIN_MININGTHREADS,CHUNGUSCOIN_LONGESTCHAIN,ASSETCHAINS_SEED,IS_CHUNGUSCOIN_NOTARY,USE_EXTERNAL_PUBKEY,CHUNGUSCOIN_CHOSEN_ONE,CHUNGUSCOIN_ON_DEMAND,CHUNGUSCOIN_PASSPORT_INITDONE,ASSETCHAINS_STAKED,CHUNGUSCOIN_NSPV;
...
extern uint256 CHUNGUSCOIN_EARLYTXID;

extern int32_t CHUNGUSCOIN_CONNECTING,CHUNGUSCOIN_CCACTIVATE,CHUNGUSCOIN_DEALERNODE;
...
extern int32_t CHUNGUSCOIN_EXCHANGEWALLET;
extern int32_t VERUS_MIN_STAKEAGE;
...
extern int32_t CHUNGUSCOIN_TESTNODE, CHUNGUSCOIN_SNAPSHOT_INTERVAL,IS_STAKED_NOTARY,STAKED_ERA;
...
void chunguscoin_netevent(std::vector<uint8_t> payload);
...
int64_t chunguscoin_priceave(int64_t *tmpbuf,int64_t *correlated,int32_t cskip);
...
int32_t chunguscoin_notarized_bracket(struct notarized_checkpoint *nps[2],int32_t height);
...
bool chunguscoin_txnotarizedconfirmed(uint256 txid);
int32_t chunguscoin_blockload(CBlock& block, CBlockIndex *pindex);
uint32_t chunguscoin_chainactive_timestamp();
uint32_t GetLatestTimestamp(int32_t height);

#ifndef CHUNGUSCOIN_NSPV_FULLNODE
#define CHUNGUSCOIN_NSPV_FULLNODE (CHUNGUSCOIN_NSPV <= 0)
#endif // !CHUNGUSCOIN_NSPV_FULLNODE
#ifndef CHUNGUSCOIN_NSPV_SUPERLITE
#define CHUNGUSCOIN_NSPV_SUPERLITE (CHUNGUSCOIN_NSPV > 0)
#endif // !CHUNGUSCOIN_NSPV_SUPERLITE
